...
I have a Bachelor (1st) in Computer Science, a Masters in Advanced Software Engineering, and a PhD in Natural Language Processing (NLP). I am interested in the application of NLP techniques in building resources for low-resource languages especially African languages, but my interests span other related areas like <em>corpus linguistics</em>, <em>distributional semantics</em>, <em>machine learning</em>, <em>data science</em>, <em>deep neural models</em> and general AI.
